...
img_top = mpimg.imread("/home/mariano/phd/hybrid_arxiv_paper/example_plots/stack_3d_new.png")
img_top = img_top[100:-100, 500:-350]
axs_left[0].imshow(img_top)
axs_left[0].set_axis_off()

img_bottom = mpimg.imread("/home/mariano/phd/hybrid_arxiv_paper/example_plots/stack_2d_new.png")
...
imgs = [
    [mpimg.imread(f"/home/mariano/phd/hybrid_arxiv_paper/frames_nb/stack1_frames/frame{k}.png") for k in range(1,5)],      # column 0: 4 RGBA images
    [mpimg.imread(f"/home/mariano/phd/hybrid_arxiv_paper/frames_nb/stack2_frames/frame{k}.png") for k in range(1,5)],      # column 1
    [mpimg.imread(f"/home/mariano/phd/hybrid_arxiv_paper/frames_nb/stacks_left_right2/frame{k}.png") for k in range(1,5)],      # column 2
]
...
plt.savefig("full_figure_stack_.pdf")
plt.show()
plt.close()
#%%
import matplotlib.pyplot as plt
...
imgs = [
    [mpimg.imread(f"/home/mariano/phd/hybrid_arxiv_paper/frames_nb/stack1_frames/frame{k}.png") for k in range(1,5)],
    [mpimg.imread(f"/home/mariano/phd/hybrid_arxiv_paper/frames_nb/stack2_frames/frame{k}.png") for k in range(1,5)],
    [mpimg.imread(f"/home/mariano/phd/hybrid_arxiv_paper/frames_nb/stacks_left_right2/frame{k}.png") for k in range(1,5)],
]
